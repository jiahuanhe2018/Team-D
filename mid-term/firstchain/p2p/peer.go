...
import (
	...
	pstoremem "github.com/libp2p/go-libp2p-peerstore/pstoremem" //suncj
...
func newHost(port int, privKey crypto.PrivKey) (*bhost.BasicHost, error) {
	...
	// pstore := pstore.NewPeerstore(nil,nil,nil)
	...
	// n, err := swarm.NewNetwork(ctx, []ma.Multiaddr{addr}, pid, pstore, nil)
	// if err != nil {
	// 	log.Error(err)
	//    return nil, err
	// }
...
// Peer stands for a logical peer of chain's p2p layer
type Peer struct {
