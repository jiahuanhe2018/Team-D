...
type ChainContext interface {
	...
	GetHeader(common.Hash, uint64) *dbtypes.Header
}
...
func NewEVMContext(tx *dbtypes.Transaction, header *dbtypes.Header, chain ChainContext, author *common.Address) Context {
...
func GetHashFn(ref *dbtypes.Header, chain ChainContext) func(n uint64) common.Hash {
