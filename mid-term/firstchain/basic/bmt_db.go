...
func NewBmtDB(db Database) *BmtDB {
	return &BmtDB{
		db: db,
	}
}
...
func (bdb *BmtDB) PutNode(batch Batch, key common.Hash, node *MerkleNode) error {
...
func (bdb *BmtDB) PutBucket(batch Batch, key common.Hash, bucket *Bucket) error {
...
func (bdb *BmtDB) PutHashTable(batch Batch, key common.Hash, ht *HashTable) error {
